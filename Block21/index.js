//Write code that defines a constructor function called Car that creates a new object with the following properties:
// make, model, and year.
class Car{
...
class ElectricCar extends Car{
    ...
    getDescription(){
        return `${super.getDescription()} with a range of ${this.range}`;
      }
}

//Create an instance of ElectricCar with the make "Tesla", model "Model S", year 2019, and range 300, 
//and the getDescription method is called on the instance. The output will be a string containing 
